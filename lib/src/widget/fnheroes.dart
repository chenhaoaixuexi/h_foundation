...
class _HeroFlight {
  ...
  void onTick() {
    final RenderBox? toHeroBox = (!_aborted && manifest.toHero.mounted) ? manifest.toHero.context.findRenderObject() as RenderBox? : null;
...
class HeroController extends NavigatorObserver {
  ...
  void _startHeroTransition(
    ...
    final Map<Object, _HeroState> fromHeroes =
        fromSubtreeContext != null ? Hero._allHeroesFor(fromSubtreeContext, isUserGestureTransition, navigator) : const <Object, _HeroState>{};
    final BuildContext? toSubtreeContext = to.subtreeContext;
    final Map<Object, _HeroState> toHeroes =
        toSubtreeContext != null ? Hero._allHeroesFor(toSubtreeContext, isUserGestureTransition, navigator) : const <Object, _HeroState>{};
    ...
    for (final MapEntry<Object, _HeroState> fromHeroEntry in fromHeroes.entries) {
      ...
      final _HeroFlightManifest? manifest = toHero == null
          ...
          : _HeroFlightManifest(
              ...
              shuttleBuilder: toHero.widget.flightShuttleBuilder ?? fromHero.widget.flightShuttleBuilder ?? _defaultHeroFlightShuttleBuilder,
